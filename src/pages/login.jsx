...
localStorage.setItem("Session", "haga")
}
    ...
    <StyledWrapper>
      ...
      <div className="container">
        ...
        <form className="form" onSubmit={LoginHandler}>
          <input placeholder="E-mail" id="email" name="email" type="email" className="input" required  onChange={((e)=> setEmail(e.target.value)) }/>
          <input placeholder="Password" id="password" name="password" type="password" className="input" required onChange={((e)=> setPassword(e.target.value) )}/>
